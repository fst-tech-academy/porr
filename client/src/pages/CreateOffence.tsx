...
import { AlertTriangle, Scale, Shield, CheckCircle, ArrowLeft, ArrowRight, X } from 'lucide-react';
import { OffenceFormData } from '../types';
...
const CreateOffencePage: React.FC = () => {
  ...
  const form = useForm<OffenceFormData>({
    resolver: yupResolver(offenceSchema),
    defaultValues: {
      name: '',
      description: '',
      code: '',
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await api.createOffence(data);
      
      if (response.success) {
        navigate('/offences');
      } else {
        setError(response.message || 'Failed to create offence');
      }
    } catch (err: any) {
      setError(err.response?.data?.message || 'Failed to create offence');
    } finally {
      setIsLoading(false);
    }
  };
          ...
          <div className="space-y-8">
            <div className="space-y-2">
              ...
              <textarea
                ...
                className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent h-32 text-black"
              />
          ...
          <div className="text-white">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  <h1 className="text-4xl font-bold">Create Offence</h1>
                  <p className="text-blue-100 text-lg">Add a new offence type to the system</p>
                </div>
              </div>
              <Button
                variant="ghost"
            ...
            <Card className="bg-white/90 backdrop-blur-sm border-0 shadow-xl">
              ...
              <CardContent className="p-8">
                ...
                <div className="flex justify-between pt-6 border-t border-gray-200">
                  ...
                  >
                    <span className="text-white">{currentStep === steps.length - 1 ? 'Create Offence' : 'Next'}</span>
...
export default CreateOffencePage;