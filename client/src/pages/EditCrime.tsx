...
const crimeSchema = yup.object({
  crimeInfo: yup.object({
    // caseNumber is auto-generated by backend
          ...
          <div className="space-y-4">
            <div className="space-y-1">
              ...
              <Input
                ...
                className={`h-10 text-black text-sm ${form.formState.errors.crimeInfo?.title ? 'border-red-500' : ''}`}
              />
              {form.formState.errors.crimeInfo?.title && (
                <p className="text-xs text-red-500 text-black">{form.formState.errors.crimeInfo.title.message}</p>
              )}
            </div>
            ...
            <div className="space-y-1">
              ...
              {form.formState.errors.crimeInfo?.description && (
                <p className="text-xs text-red-500 text-black">{form.formState.errors.crimeInfo.description.message}</p>
              )}
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              <div className="space-y-1">
                ...
                <Input
                  ...
                  className={`h-10 text-black text-sm ${form.formState.errors.dateTime?.dateCommitted ? 'border-red-500' : ''}`}
                />
                {form.formState.errors.dateTime?.dateCommitted && (
                  <p className="text-xs text-red-500 text-black">{form.formState.errors.dateTime.dateCommitted.message}</p>
                )}
              </div>
            ...
            <div className="space-y-1">
              ...
              <Input
                ...
                className={`h-10 text-black text-sm ${form.formState.errors.dateTime?.dateReported ? 'border-red-500' : ''}`}
              />
              {form.formState.errors.dateTime?.dateReported && (
                <p className="text-xs text-red-500 text-black">{form.formState.errors.dateTime.dateReported.message}</p>
              )}
            </div>
          </div>
        );
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card className="bg-gray-50 border-gray-200 shadow-sm">
                ...
                <CardContent className="space-y-2 text-sm text-black">
                  <p><strong className="text-black">Case Number:</strong> <span className="text-black italic text-gray-500">Auto-generated (e.g., 0000001)</span></p>
          ...
          <div className="lg:col-span-1">
            <Card className="bg-white dark:bg-slate-800 shadow-lg border-gray-200 dark:border-slate-700 sticky top-4">
              <CardHeader className="bg-gradient-to-r from-blue-600 to-blue-700 text-white py-3">
                <CardTitle className="text-lg font-semibold">Crime Registration</CardTitle>
              </CardHeader>
