...
import { UserCheck, Shield, Building2, User, CheckCircle, ArrowLeft, ArrowRight, Lock } from 'lucide-react';
            ...
            <Card className="bg-white/90 backdrop-blur-sm border-0 shadow-xl">
              ...
              <CardContent className="p-4">
                ...
                <div className="flex justify-between pt-4 border-t border-gray-200">
                  ...
                  >
                    <span className="text-white">{currentStep === steps.length - 1 ? 'Create Agent' : 'Next'}</span>
