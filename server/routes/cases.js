...
// Create new case
router.post('/', protect, authorize(['admin', 'manager', 'officer']), [
...
// Update case
router.put('/:id', protect, authorize(['admin', 'manager', 'officer']), [
  param('id').isMongoId().withMessage('Invalid case ID'),
...
// Update case status
router.patch('/:id/status', protect, authorize(['admin', 'manager', 'officer']), [
  param('id').isMongoId().withMessage('Invalid case ID'),
...
// Add timeline event
router.post('/:id/timeline', protect, authorize(['admin', 'manager', 'officer']), [
  param('id').isMongoId().withMessage('Invalid case ID'),
